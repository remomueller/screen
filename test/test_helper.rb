...
class ActionDispatch::IntegrationTest
  def sign_in_as(user_template, password, email)
    ...
    user.update_column :screener, user_template.screener?
    user.update_column :subject_handler, user_template.subject_handler?
    user.update_column :access_phi, user_template.access_phi?
