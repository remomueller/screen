...
Manage prescreens and call log. Using Rails 4.0+ and Ruby 2.1.0+.
...
0 1 * * * source /etc/profile.d/rvm.sh && cd /var/www/screen && /usr/local/rvm/gems/ruby-2.1.0/bin/bundle exec rake flag_priority RAILS_ENV=production
```
